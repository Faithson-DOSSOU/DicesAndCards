...
export default {
  components: {Home, Events, Catalogue, LanguagePanel},
  name: 'AdminHeader',
...
<template>
  <header class="header">
    <div class="header-wrapper">
      <router-link to="/AdminEvents" class="logo-link"><img class="logo" :src="logo" alt="logo of dices and cards"></router-link>
      <nav>
        <ul class="nav-list">
          <li class="nav-link-wrapper"><router-link active-class="active" to="/AdminEvents"  class="nav-link">Evènements</router-link></li>
          <li class="nav-link-wrapper"><router-link active-class="active" to="/Catalogue"  class="nav-link">Catalogue</router-link></li>
          <li class="nav-link-wrapper"><router-link active-class="active" to="/About"  class="nav-link">Users</router-link></li>
        </ul>
      </nav>
